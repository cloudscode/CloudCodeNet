...
{
    public class CloudCodeDataGrid
    {
        ...
        public CloudCodeDataGrid(string controlName)
        {
        ...
        private string BuildGrid()
        {
            ...
            {
                CloudCode.Web.Controls.CloudCodeDataGrid.Column currentColumn = (CloudCode.Web.Controls.CloudCodeDataGrid.Column)column.Value;
            ...
            if (ReturnStatus == true)
            {
                ...
                foreach (DictionaryEntry row in rows)
                {
                    ...
                    List<CloudCode.Web.Controls.CloudCodeDataGrid.Column> rowColumns = (List<CloudCode.Web.Controls.CloudCodeDataGrid.Column>)row.Value;

                    foreach (CloudCode.Web.Controls.CloudCodeDataGrid.Column column in rowColumns)
                    {
